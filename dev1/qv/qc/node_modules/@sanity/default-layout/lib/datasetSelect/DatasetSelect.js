...
function DatasetSelect(props) {
  ...
  (0, _react.useEffect)(() => {
    var currentSpace$ = _urlState.state.pipe((0, _operators.filter)(_urlState.isResolvedEvent), (0, _operators.map)(event => event.state && event.state.space), (0, _operators.map)(spaceName => _spaces.CONFIGURED_SPACES.find(sp => sp.name === spaceName)));
